...
with col2:
    ...
    st.link_button("🔗 Visit my LinkedIn", SOCIAL_MEDIA["LinkedIn"])
...
st.write("""
- ✔️ Over 15 years of experience in software testing and test automation, with a focus on backend/API and mobile
  network protocols
- ✔️ Strong hands-on experience in Python (pytest, BDD), SQL, AWS, GraphQL, MongoDB, Gitlab, Linux
- ✔️ Proven track record in designing, implementing, and maintaining automated test frameworks for backend APIs
  and mobile devices
...
st.write("""
- Built and maintained automated test frameworks using Python and pytest, applying OOP principles for scalability
  and reuse.
...
- Worked with PostgreSQL, GraphQL, MongoDB, Snowflake, and Linux environments, using Bash scripting to automate
  test and CI/CD tasks
    """)
...
st.write("""
- Developed and maintained automated test cases for mobile network protocol tests on Android devices (Python, Git,
  Jira, Linux, Android Comms Test Suite)
